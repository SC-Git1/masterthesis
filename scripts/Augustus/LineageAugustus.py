...
if __name__ == "__main__":
    # import data
    df = pd.read_csv("NCBI_AugustusUpdated_TaxIDs_man.tsv", delimiter="\t", header=0, index_col=False, dtype={"ncbiTaxID": str})
    ...
    with open("NCBI_Annotated_AugustusUpdated.tsv", "w") as f:
        # header
        f.write("ncbiTaxID" + "\t" + "Name" + "\t" + "Identifier" + "\t" + "Superkingdom" + "\t" +
        ...
        for i in range(len(IDs)):
            ...
            try:
                ...
                pass
            f.write(el + "\t" + Names[i] + "\t" + Identifiers[i] + "\t" + Superkingdom + "\t" + Phylum +
